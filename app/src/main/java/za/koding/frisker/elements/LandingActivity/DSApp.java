...
/**
 * The custom element class for DSApp which extends
 * {@link android.webkit.WebView}. This element's parent page is
 * {@link za.koding.frisker.activities.LandingActivity},
 * and its parent element is {@link za.koding.frisker.elements.LandingActivity.DSFrisk}.
 ...
 * wideViewportEnabled.
 */
public class DSApp extends WebView implements DropsourceVaried {
  /**
  ...
  /**
   * {@link #DSApp(Context, AttributeSet)}
   */
  ...
  /**
   * {@link #DSApp(Context, AttributeSet, int)}
   */
  public DSApp(Context context, AttributeSet attrs) {
   ...
   *
   */
  public DSApp(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    this.loadUrl("https://d3hz1qd00d5r9a.cloudfront.net");
  }
  ...
  /**
   * Retrieves the parent {@link DSFrisk} of this element.
   *
   * @return the parent {@link DSFrisk}
   */
  public DSFrisk _getParent() {
    return (DSFrisk) getParent();
  }
}