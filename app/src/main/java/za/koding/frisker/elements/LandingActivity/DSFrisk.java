...
/**
 * The custom element class for DSFrisk which extends
 ...
 * enabled; and 1 children: {@link za.koding.frisker.elements.LandingActivity.DSApp}.
 */
public class DSFrisk extends PercentRelativeLayout implements DropsourceVaried {
  /**
  ...
  /**
   * {@link #DSFrisk(Context, AttributeSet)}
   */
  public DSFrisk(Context context) {
    this(context, null);
  }

  /**
   * {@link #DSFrisk(Context, AttributeSet, int)}
   */
  public DSFrisk(Context context, AttributeSet attrs) {
   ...
   *
   */
  public DSFrisk(Context context, AttributeSet attrs, int defStyleAttr) {
    super(context, attrs, defStyleAttr);

    this.variant = "Default";

    this.setId(R.id.frisk);
  }
  ...
  /**
   * This element's child app.
   */
  public DSApp _getApp() {
    return (DSApp) this.findViewById(R.id.app);
  }
}